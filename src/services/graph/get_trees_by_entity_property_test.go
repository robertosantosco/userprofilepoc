...
var _ = Describe("GetTreesByEntityProperty", func() {
	var (
	...
	Context("Basic search by property", func() {
		Context("no entities exist in database", func() {
			When("searching for any property", func() {
				It("should return domain not found error", func() {
					// ARRANGE

					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "email", "test@example.com", defaultDepth, defaultReferenceDate)
		...
		Context("only one entity exists in database", func() {
			When("searching for property that does not exist in entity", func() {
				It("should return domain not found error", func() {
					// ARRANGE
			...
			When("searching for property that exists in entity", func() {
			...
			When("searching for property value that does not match", func() {
				It("should return domain not found error", func() {
					// ARRANGE
					existingEntity := stubs.NewEntityStub().
						WithProperties(map[string]interface{}{
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "email", "different@example.com", defaultDepth, defaultReferenceDate)
		...
		Context("multiple entities exist in database", func() {
			When("searching for property that does not exist in any entity", func() {
				It("should return domain not found error", func() {
					// ARRANGE
					entity1 := stubs.NewEntityStub().
						WithProperties(map[string]interface{}{
							"name": "John Doe",
							"age":  30,
						}).
						Get()
					entity2 := stubs.NewEntityStub().
						WithProperties(map[string]interface{}{
							"name": "Jane Smith",
							"age":  25,
						}).
			...
			When("searching for property that exists in one entity", func() {
				It("should return expected domain.NodeTree list", func() {
					// ARRANGE
					entity1 := stubs.NewEntityStub().
						WithProperties(map[string]interface{}{
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "email", "john@example.com", defaultDepth, defaultReferenceDate)
			...
			When("searching for property that exists in multiple entities", func() {
				It("should return all matching entities", func() {
					// ARRANGE
					entity1 := stubs.NewEntityStub().
						WithProperties(map[string]interface{}{
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "department", "Engineering", defaultDepth, defaultReferenceDate)
		...
		Context("entities with multiple levels", func() {
			When("searching with lower number of levels", func() {
				It("should return only entities from requested level in edges", func() {
					// ARRANGE
					rootEntity1 := stubs.NewEntityStub().
						WithProperties(map[string]interface{}{
							"type": "manager",
							"name": "Manager One",
						}).
						Get()
					rootEntity2 := stubs.NewEntityStub().
						WithProperties(map[string]interface{}{
							"type": "manager",
							"name": "Manager Two",
						}).
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "type", "manager", 1, defaultReferenceDate)
			...
			When("searching with equal number of levels", func() {
				It("should return all associated entities in edges", func() {
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "type", "manager", 2, defaultReferenceDate)
			...
			When("searching with higher number of levels", func() {
				It("should return only associated entities in edges", func() {
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "type", "manager", 5, defaultReferenceDate)
		...
		Context("entities have no levels", func() {
			When("searching with any depth", func() {
				It("should return empty list in edges", func() {
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "status", "active", defaultDepth, defaultReferenceDate)
		...
		Context("entities with multiple temporal data for last month", func() {
			When("requesting temporal data from current month", func() {
				It("should return empty list in temporal data", func() {
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "category", "premium", defaultDepth, currentMonth)
			...
			When("requesting temporal data from last month", func() {
				It("should return temporal data", func() {
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "category", "premium", defaultDepth, lastMonth)
		...
		Context("entities with multiple temporal data in last three months", func() {
			...
			When("requesting temporal data from two months ago onwards", func() {
				It("should return temporal data from two months ago, last month and current", func() {
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "category", "premium", defaultDepth, twoMonthsAgo)
			...
			When("requesting temporal data from five months ago", func() {
				It("should return temporal data from last 3 months", func() {
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "category", "premium", defaultDepth, fiveMonthsAgo)
		...
		Context("entities with relationships and temporal data", func() {
			When("searching entities with temporal data and nested edges", func() {
				It("should return complete structure with temporal data at correct levels", func() {
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "level", "senior", 2, currentMonth)
			...
			When("searching with limited depth and temporal data from different months", func() {
				It("should return only temporal data from requested month at all levels", func() {
					...
					// ACT
					trees, err := graphService.GetTreesByEntityProperty(ctx, "level", "senior", 1, currentMonth)
